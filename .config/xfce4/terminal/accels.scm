...
(gtk_accel_path "<Actions>/terminal-window/preferences" "<Alt>,")
...
; (gtk_accel_path "<Actions>/terminal-window/close-window" "<Alt>w")
...
(gtk_accel_path "<Actions>/terminal-window/new-window" "<Alt><Shift>n")
